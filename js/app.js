/**
 * GHAZI OTT — High Performance Mobile App Client
...
(function () {
    ...
    function loadUserData() {
        try {
            ...
            recent = JSON.parse(localStorage.getItem('ghazi_recent') || '[]');
        } catch (e) {
            watchlist = [];
            recent = [];
        }
    ...
    function saveRecent() {
        localStorage.setItem('ghazi_recent', JSON.stringify(recent));
    }
        ...
        card.innerHTML = `
            ...
            <div class="card-info-peek">
                ...
                <div class="card-sub-text">
                    ...
                    <span style="color:var(--green);font-weight:700;">HD</span>
                </div>
            </div>
        `;
        ...
        heroItems.forEach((m, idx) => {
            ...
            slide.innerHTML = `
                ...
                <div class="hero-content">
                    <div class="hero-badge-tag"><i class="fas fa-bolt"></i> Ghazi Exclusive</div>
